<template>
	<div class="kumo-page">
		<n-card :bordered="false" size="small" class="mb-16px">
			<div class="flex items-center justify-between gap-12px flex-wrap">
				<div class="flex items-center gap-12px">
					<span class="font-bold text-16px">KumoMTA Connection</span>
			...
			<n-grid :cols="4" :x-gap="16" :y-gap="12" responsive="screen" class="mt-16px">
				<n-grid-item>
		...
		<n-card :bordered="false" size="small" class="mb-16px">
			<template #header>Runtime Controls</template>
		...
		<n-card :bordered="false" size="small" class="mb-16px">
			<template #header>KumoMTA Policy Preview</template>
			...
			<n-space vertical :size="12">
				...
				<n-form-item v-if="preview.files.length" label="Artifact">
					<n-select v-model:value="selectedPolicyPath" :options="policyFileOptions" class="w-360px" />
				</n-form-item>
				<n-input
		...
		<n-card :bordered="false" size="small">
			<template #header>Recent checks</template>
